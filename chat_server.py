...
# ==============================================================================
    def handle_msg(self, from_sock):
        ...
        # myrec 在utility里面，进行encode，用来返回一个jason msg
        if len(msg) > 0:
            # ==============================================================================
            ...
            if msg["action"] == "connect":
                ...
                ## what does this mean? "if to_name == from_name", isn't this causing error?
                # answer: this is checking whether the target is already in a group
...
# ==============================================================================
                ...
                # IMPLEMENTATION
                # ---- start your code ---- #
                for member in self.group.list_me(from_name):
                    self.indices[member].add_msg_and_index(text_proc(msg['message'],from_name))
                # ---- end of your code --- #
                ...
                for g in the_guys:
                    ...
                    print('before json')
                    message = json.dumps(
                        {"action": "exchange", "from": from_name, 'msg': msg['message']})
                    mysend(to_sock, message)
                    print('after jason')
