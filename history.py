...
from tkinter import Toplevel,Tk, Frame, Scrollbar, Label, END, Entry, Text, VERTICAL, Button,StringVar, Message, messagebox  # Tkinter Python Module for GUI
import tkinter.messagebox as msgbx
import time
import threading
...
class MainWindow():
    def __init__(self, master):
        print("class")
        self.MainWindow = Toplevel(master)
    ...
    def display_middle_frame(self):
        ...
        leaveChat = Button(MiddleFrame, text='Leave Conversation', font=("Helvetica", 16),
                           command=self.setChatInstruction)
